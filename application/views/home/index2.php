<div class="page-body-wrapper">
								...
								<div class="d-sm-flex justify-content-between">
									<div data-aos="zoom-in-up">
										<div class="banner-title">
												<h3 class="font-weight-medium">Dewi Sartika Award 2022
											</h3>
										</div>
										<p class="mt-3">more info<a href="https://orarijabar.or.id/beranda/spesial_detail/13"> https://orarijabar.or.id </a>
										...
										<form method="post" action="<?php echo site_url('search'); ?>" target="_blank">
											...
											<div class="row">
													...
													<div class="form-group">
														<input class ="form-control btn btn-outline-info" type="text" id="search2" required="true" value="" name="callsign" placeholder="your callsign" autocomplete="off" spellcheck="false"/>
									...
									<div class="mt-5 mt-lg-0">
										<img src="<?php echo base_url();?>assets/images/rds-besar-png.png" alt="raden-dewi-sartika" class="img-fluid" data-aos="zoom-in-up">
									</div>
								</div>
							</div>
						</div>
			...
			<section class="our-process" id="award">
				<div class="container">
					<div class="row mb-5">
						<div class="col-sm-12">
							<div class="d-sm-flex justify-content-between align-items-center mb-2">
								<h3 class="font-weight-medium text-dark ">Award Rules</h3>
								<div></div>
							</div>
						</div>
					</div>
			...
			<section class="our-projects" id="rangking">
				<div class="container">
					<div class="row mb-5">
						<div class="col-sm-12">
							<div class="d-sm-flex justify-content-between align-items-center mb-2">
								<h3 class="font-weight-medium text-dark ">Rangking</h3>
								<div></div>
							</div>
						</div>
					</div>
